...
"""
Генератор заказов по матрёшке периодов
Количество заказов в день колеблется ±1 вокруг введённого среднего значения
"""
...
def generate_orders_in_period(period_type: str,
                              avg_orders_per_day: int,      # среднее значение
    ...
    while current_date <= end_date:
        # Колебание ±1 вокруг среднего значения
...
if __name__ == "__main__":
    print("=== ГЕНЕРАТОР ЗАКАЗОВ ПО МАТРЁШКЕ (4 этапа) ===\n")
